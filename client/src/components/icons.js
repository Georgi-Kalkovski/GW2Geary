...
import Mesmer_Icon from './img/Mesmer_icon.png';
import Necromancer_Icon from './img/Necromancer_icon.png';
import Ranger_Icon from './img/Ranger_icon.png';
...
const wikiBigProfessionIcons = {
    ...
    Guardian: Guardian_Icon,
    Mesmer: Mesmer_Icon,
    Necromancer: Necromancer_Icon,
    Ranger: Ranger_Icon,
    Revenant: Revenant_Icon,
    Thief: Thief_Icon,
...
const wikiSmallProfessionIcons = {
    ...
    Guardian: Guardian_icon_white,
    Mesmer: Mesmer_icon_white,
    Necromancer: Necromancer_icon_white,
    Ranger: Ranger_icon_white,
    Revenant: Revenant_icon_white,
